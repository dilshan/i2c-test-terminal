 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x31, 0x12 /* obdev's shared PID for HIDs */
 ...
 */
#define USB_CFG_VENDOR_NAME     'D', 'i', 'l', 's', 'h', 'a', 'n'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'I', '2', 'C', ' ', 'T', 'e', 'r', 'm', 'i', 'n', 'a', 'l'
